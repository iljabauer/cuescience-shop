...
class TestCheckoutWizardWithBillingAddress(TestCase):
    ...
    def test(self):
        """
         The code in this method is generated from: /de.iljabauer.projects.natspec.python/cuescience_cart/tests/views/checkout_wizard/test_checkout_wizard_with_billing_address.natspec
        ...
        # - different billing address: True
        self.test_support.collect_checkout_data([u("different"), u("billing"), u("address")], [u("True")], checkoutRequest_0, currentStep_2)
        
        # Submit
        response_1 = self.test_support.submit(checkoutRequest_0)
        
        # Assert step 3 of wizard is displayed
        self.test_support.assert_step_of_wizard(3, response_1)
        
        # Enter data:
        checkoutRequest_1 = self.test_support.submit_data()
        
        # - current step: 3
        currentStep_3 = self.test_support.current_step_data(3, checkoutRequest_1)
        
        # - street: Test Place
        self.test_support.collect_checkout_data([u("street")], [u("Test"), u("Place")], checkoutRequest_1, currentStep_3)
        
        # - number: 99
        self.test_support.collect_checkout_data([u("number")], [u("99")], checkoutRequest_1, currentStep_3)
        
        # - postcode: 01159
        self.test_support.collect_checkout_data([u("postcode")], [u("01159")], checkoutRequest_1, currentStep_3)
        
        # - city: Dresden
        self.test_support.collect_checkout_data([u("city")], [u("Dresden")], checkoutRequest_1, currentStep_3)
        
        # Submit
        response_2 = self.test_support.submit(checkoutRequest_1)
        
        # Assert step 4 of wizard is displayed
        self.test_support.assert_step_of_wizard(4, response_2)
        
        # Enter data:
        checkoutRequest_2 = self.test_support.submit_data()
        
        # - current step: 4
        currentStep_4 = self.test_support.current_step_data(4, checkoutRequest_2)
        
        # - paypent_options: PayPal
        self.test_support.collect_checkout_data([u("paypent_options")], [u("PayPal")], checkoutRequest_2, currentStep_4)
        
        # Submit
        response_3 = self.test_support.submit(checkoutRequest_2)
        
        # Assert total cart item count: 0
        self.test_support.assert_total_item_count(0, response_3)
        ...
        # Assert client has billing address: Test Place, 99, 01159, Dresden
        self.test_support.assert_client_shipping_address([u("Test"), u("Place")], [u("99")], u("01159"), [u("Dresden")], u("billing"), client_John_Doe)
